...
//   // Create training sessions for each performance metric
//   const trainingData = await Promise.all(metrics.map(async (metric) => ({
//     name: `${metric.name} Training`,
//     description: `Training for improving ${metric.name}`,
//     startDate: new Date('2023-12-01'), // Start date is fixed at December 1, 2023
//     endDate: currentDate, // End date is today's date
//     trainerId: await getRandomTrainerId(), // Use the function here
//   })));
...
// // Function to get a random trainer ID for training assignment
// async function getRandomTrainerId() {
//   const trainers = await prisma.user.findMany({ where: { role: 'TRAINER' } });
//   const randomTrainer = trainers[Math.floor(Math.random() * trainers.length)];
//   return randomTrainer.id;
// }
...
//     CurrentValue: 0, // Changed to CurrentValue
//   },
//   {
...
// // Create the performance metrics in the database
// await prisma.performanceMetrics.createMany({
//   data: performanceMetrics.map(metric => ({
//     name: metric.name,
//     description: metric.description,
//     CurrentValue: metric.CurrentValue, // Changed to CurrentValue
//   })),
// });
